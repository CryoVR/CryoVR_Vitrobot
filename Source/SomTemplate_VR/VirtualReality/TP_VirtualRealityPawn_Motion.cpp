...
void ATP_VirtualRealityPawn_Motion::SetScore(float i)
{	
	Score = i;
}

float ATP_VirtualRealityPawn_Motion::GetScore()
{
	return Score;
}
...
void ATP_VirtualRealityPawn_Motion::SetisFinished(bool i)
{
	isFinished = i;
}
